...
resource "aws_iam_policy" "ec2_s3_full_access_policy" {
  name        = "ec2_s3_full_access_policy_1"
...
resource "aws_iam_role" "ec2_s3_full_access_role" {
  name = "ec2_s3_full_access_role_1"
...
resource "aws_iam_policy_attachment" "ec2_s3_policy_attachment" {
  ...
  roles      = [aws_iam_role.ec2_s3_full_access_role_1.name]
  policy_arn = aws_iam_policy.ec2_s3_full_access_policy_1.arn
}

### Create instance profile using role
resource "aws_iam_instance_profile" "ec2_s3_instance_profile" {
  name = "ec2_s3_instance_profile"
  role = aws_iam_role.ec2_s3_full_access_role_1.name
}
